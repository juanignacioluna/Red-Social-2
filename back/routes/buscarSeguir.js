    ...
    (async () => {
        ...
        try{
                ...
                if(req.body.val=="SEGUIR"){
                    ...
                    const ahBo2 = await User2.findOneAndUpdate({ arroba: req.body.arroba }, { $inc: { seguidores: 0.5 } }, {new: true },function(err, response) {
                ...
                if(req.body.val=="SIGUIENDO"){
                    ...
                    const ahBo2 = await User.findOne({esteUsuario: session.arroba, sigueAa: req.body.arroba});  //SELECT
                    ...
                    const ahBo3 = await User2.findOneAndUpdate({ arroba: req.body.arroba }, { $inc: { seguidores: -0.5 } }, {new: true },function(err, response) {
